...
// O(n) linear; as the number of sheep increases the number of operations increases proportionally
...
// O(n) linear; number of operations directly proportional to data set size
...
// O(n) linear; number of operations is proportional to string length
...
// O(n) linear; number of operations is proportional to input.
...
// O(n) linear; number of operations is proportional to number of separators in the array.
...
// O(log(n)) logarithmic; number of operations is not affected by the input due to halving each iteration. Number of operations are significantly less than the size of the input number.
...
// O(n) linear; number of operations is proportional to the number input
...
// O(n) linear; number of operations is proportional to the input


/*=================================================================================
Exercise 9 - Anagram
Too tedious to do this iteratively
*/

/*
Exercise 8 - Animal Hierarchy
Analyze it recursively - no iterative version needed
*/
